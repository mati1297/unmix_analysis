...
from unmix.hparams import Hyperparams, setup_hparams, REMOTE_PREFIX
from unmix.utils.remote_utils import download
from unmix.utils.torch_utils import freeze_model
...
"""
# for pretrained model and deployment
...
def make_prior(hps, vqvae, device='cuda'):
    from unmix.prior.prior import SimplePrior
    ...
    if hps.fp16_params:
        ...
        from unmix.transformer.ops import _convert_conv_weights_to_fp16
