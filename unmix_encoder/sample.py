...
from unmix_encoder.data.labels import EmptyLabeller
from unmix_encoder.utils.torch_utils import empty_cache
from unmix_encoder.utils.audio_utils import save_wav, load_audio
from unmix_encoder.make_models import make_model
from unmix_encoder.align import get_alignment
from unmix_encoder.save_html import save_html
from unmix_encoder.utils.sample_utils import split_batch, get_starts
...
def save_samples(model, device, hps, sample_hps):
    print(hps)
    from unmix_encoder.lyricdict import poems, gpt_2_lyrics
